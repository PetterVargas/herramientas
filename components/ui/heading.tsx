  ...
  switch (level) {
    ...
    case 2:
      return (
        <h2
          className={cn(
            `scroll-m-20 pb-2 text-2xl font-semibold tracking-tight transition-colors first:mt-0 lg:text-3xl`,
            className,
          )}
        >
          {children}
    ...
    case 5:
      return (
        <h5
          className={cn('scroll-m-20 text-base font-medium lg:text-lg', className)}
        >
          {children}
        </h5>
      );
